...
const payables = [
  { id: "PAG-2042", supplier: "Distribuidora Peças S.A.", description: "Lote de Compressores", amount: "R$ 32.500,00", dueDate: "05/04/2026", status: "Atrasado" },
  { id: "PAG-2043", supplier: "Posto Ipiranga", description: "Combustível Frota - Março", amount: "R$ 15.000,00", dueDate: "10/04/2026", status: "Pendente" },
  { id: "PAG-2044", supplier: "Imobiliária Centro", description: "Aluguel Galpão", amount: "R$ 8.400,00", dueDate: "15/04/2026", status: "Pendente" },
  { id: "PAG-2045", supplier: "Contabilidade Silva", description: "Honorários Contábeis", amount: "R$ 2.850,00", dueDate: "02/04/2026", status: "Pago" },
  { id: "PAG-2046", supplier: "Fornecedor Ferramentas", description: "Kits de Instalação", amount: "R$ 12.000,00", dueDate: "20/04/2026", status: "Pendente" },
];
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Contas a Pagar</h1>
          <p className="text-slate-500 mt-2 text-base">Gestão de pagamentos, despesas e fornecedores.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-3xl border border-slate-200/60 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-bold text-slate-700">Pago (Mês)</h3>
          </div>
          <p className="text-3xl font-extrabold text-slate-900">R$ 42.850</p>
        </div>
        <div className="bg-white p-6 rounded-3xl border border-slate-200/60 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-bold text-slate-700">A Pagar (Mês)</h3>
          </div>
          <p className="text-3xl font-extrabold text-slate-900">R$ 85.400</p>
        </div>
        <div className="bg-white p-6 rounded-3xl border border-slate-200/60 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
          ...
          <p className="text-3xl font-extrabold text-slate-900">R$ 32.500</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200/60 shadow-sm overflow-hidden flex flex-col">
        <div className="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="relative flex-1 max-w-md">
            ...
            <input 
              type="text" 
              placeholder="Buscar por fornecedor, ID ou descrição..." 
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-100">
                <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider">ID / Fornecedor</th>
              ...
              {payables.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50/50 transition-colors group">
                  <td className="px-6 py-4">
                    <div className="font-bold text-slate-900">{item.supplier}</div>
